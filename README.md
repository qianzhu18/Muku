...
- 中文名：`幕库`
- 英文名：`Muku`
- 推荐仓库名：`muku-video-to-markdown`
- 推荐 skill 名：`muku-video-kb`
- 当前兼容 CLI 命令：`video-downloade`
...
- 公开 skill：[skills/muku-video-kb/SKILL.md](skills/muku-video-kb/SKILL.md)
- 仓库内本地 skill：[.codex/skills/muku-video-kb/SKILL.md](.codex/skills/muku-video-kb/SKILL.md)
...
- 当前更适合个人、本地或小范围自用
- 当前品牌已经切换为“幕库 Muku”，但 CLI / 包名仍保留 `video-downloade` 作为兼容标识
- 如果后续需要彻底改名，可以在下一步再补 `muku` CLI alias、包名迁移和仓库重命名
